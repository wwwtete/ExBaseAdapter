...
public class AnimationVH extends BaseVH<Status> {
    ...
    protected void onBindData(Status status) {
        ...
        mTweetText.setMovementMethod(ClickableMovementMethod.getInstance());
        mTweetText.setFocusable(false);
        mTweetText.setClickable(false);
        mTweetText.setLongClickable(false);
    }
